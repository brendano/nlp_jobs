...
query types.  
\newcite{Dakka:08} evaluate a document facet generation system against AMT-supplied facets, and also use AMT workers for user studies of the system.
...
%[[possible other citations:  \cite{Sheng:08}.
 \vspace*{-0.05in}
...
%\newblock KDD 08 [[ TODO if use this make correcter ]]
